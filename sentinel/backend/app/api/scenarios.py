...
def get_preset_scenarios() -> list[dict[str, Any]]:
    ...
    return [
        ...
        # ── Scenario 5: TCS Thermal Runaway ──────────────────────────────
        {
            ...
            "source_type": "Synthetic Safe Mode",
            "source_note": "Synthetically generated thermal runaway scenario modelled on ECSS-Q-ST-30-02C thermal failure signatures.",
        ...
        # ── Scenario 6: COMMS Transponder Loss ───────────────────────────
        {
            ...
            "source_type": "Synthetic Safe Mode",
            "source_note": "Synthetically generated communication loss scenario. Transponder lockout with loss of downlink signal.",
            ...
            "pre_fault_telemetry": [
                {"parameter": "RF_power_dBm", "value": -102.0,
                 "nominal_min": -95.0, "nominal_max": -70.0},
                {"parameter": "Bit_error_rate", "value": 0.08,
                 "nominal_min": 0.0, "nominal_max": 0.001},
                {"parameter": "Transponder_temp_C", "value": 55.0,
                 "nominal_min": -10.0, "nominal_max": 50.0},
                {"parameter": "Link_margin_dB", "value": -3.5,
                 "nominal_min": 3.0, "nominal_max": 20.0},
